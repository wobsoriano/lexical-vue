...
const CASES: Case[] = [
  { name: 'AutoFocusPlugin', load: () => import('../src/LexicalAutoFocusPlugin.vine') },
  {
    name: 'AutoLinkPlugin',
    load: () => import('../src/LexicalAutoLinkPlugin.vine'),
    props: { matchers: [] },
  },
  {
    name: 'LexicalAutoScrollPlugin',
    load: () => import('../src/LexicalAutoScrollPlugin.vine'),
    props: { scrollRef: null },
  },
  { name: 'CharacterLimitPlugin', load: () => import('../src/LexicalCharacterLimitPlugin.vine') },
  { name: 'CheckListPlugin', load: () => import('../src/LexicalCheckListPlugin.vine') },
  { name: 'ClearEditorPlugin', load: () => import('../src/LexicalClearEditorPlugin.vine') },
  { name: 'ClickableLinkPlugin', load: () => import('../src/LexicalClickableLinkPlugin.vine') },
  { name: 'ContentEditable', load: () => import('../src/LexicalContentEditable.vine') },
  { name: 'HashtagPlugin', load: () => import('../src/LexicalHashtagPlugin.vine') },
  { name: 'HistoryPlugin', load: () => import('../src/LexicalHistoryPlugin.vine') },
  { name: 'HorizontalRulePlugin', load: () => import('../src/LexicalHorizontalRulePlugin.vine') },
  { name: 'LinkPlugin', load: () => import('../src/LexicalLinkPlugin.vine') },
  { name: 'ListPlugin', load: () => import('../src/LexicalListPlugin.vine') },
  {
    name: 'MarkdownShortcutPlugin',
    load: () => import('../src/LexicalMarkdownShortcutPlugin.vine'),
    props: { transformers: [] },
  },
  {
    name: 'OnChangePlugin',
    load: () => import('../src/LexicalOnChangePlugin.vine'),
    props: { onChange: () => {} },
  },
  ...
  { name: 'RichTextPlugin', load: () => import('../src/LexicalRichTextPlugin.vine') },
  {
    ...
    load: () => import('../src/LexicalSelectionAlwaysOnDisplay.vine'),
  },
  { name: 'TabIndentationPlugin', load: () => import('../src/LexicalTabIndentationPlugin.vine') },
  {
    name: 'TableOfContentsPlugin',
    load: () => import('../src/LexicalTableOfContentsPlugin.vine'),
    slots: { default: () => h('div') },
  },
  { name: 'TablePlugin', load: () => import('../src/LexicalTablePlugin.vine') },
